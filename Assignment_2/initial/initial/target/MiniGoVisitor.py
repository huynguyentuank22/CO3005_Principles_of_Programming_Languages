...
class MiniGoVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by MiniGoParser#ele_field.
    def visitEle_field(self, ctx:MiniGoParser.Ele_fieldContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by MiniGoParser#if_tail.
    ...
    # Visit a parse tree produced by MiniGoParser#for_step.
    def visitFor_step(self, ctx:MiniGoParser.For_stepContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MiniGoParser#for_each.
